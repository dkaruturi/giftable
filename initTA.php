...
<html>
 ...
 <?php
     ...
     // INITIALIZE DATABASE
      ...
      $result = $db->query(
                "CREATE TABLE `localhost`.`Users` ( `Users #` INT NOT NULL AUTO_INCREMENT, `name` VARCHAR(100) NOT NULL ,`username` VARCHAR(100) NOT NULL , `password` VARCHAR(100) NOT NULL , `email` VARCHAR(100) NOT NULL, `hash` VARCHAR(500) NOT NULL, `type` VARCHAR(100) NOT NULL , PRIMARY KEY (`Users #`))") or die ("Invalid: " . $db->error);
      
      $db->query("INSERT INTO `USERS` VALUES (NULL,'Sanjana Mendu','sanjana',MD5('sanjana'),'uva.cs4501@gmail.com','','admin')");
      $db->query("INSERT INTO `USERS` VALUES (NULL,'Admin1','admin1',MD5('admin1'),'uva.cs4501+admin1@gmail.com','','admin')");
      $db->query("INSERT INTO `USERS` VALUES (NULL,'Admin2','admin2',MD5('admin2'),'uva.cs4501+admin1@gmail.com','','admin')");
      $db->query("INSERT INTO `USERS` VALUES (NULL,'User1','user1',MD5('user1'),'uva.cs4501+admin1@gmail.com','','user')");
      ...
      $tables = array("Tickets"=>array("Ticket #", 
                      ...
                      "Users"=>array("Users #","username", "password","email","type"));
